...
//  useCompactVMConfiguration();
  ...
  setUp(() {
    return getWebDriver()
        ...
        .then((_) =>
            driver.findElement(new By.id('toggle')))
        .then((_element) => button = _element)
        .then((_) =>
            driver.findElement(new By.id('expandedLex')))
  ...
  group("webdriver", () {
    solo_seleniumTest('should have + and extended', () {
      ...
      return text.text.then(expectAsync(
       (_text) {
    ...
    solo_seleniumTest('change expanded to collapsed after click', () {
      return driver.mouse.moveTo(element: button).click()
          .then((_) => sleep(100)) //because of animation frame
          .then((_) =>
                      driver.findElement(new By.id('collapsed')))
          .then((_element) => text = _element)
          .then((_) => text.text)
          .then((_text) {
