...
main() {
  group("(registerComponent", () {
    test("should register component factory", () {
      var factory =
          registerComponent(({props, children}) => new ComponentMock());
      expect(factory is ComponentDescriptionFactory, isTrue);
    });

    test(
        "should create component description factory, which can produce component description with props, children and key",
        () {
      ...
      ComponentDescription description =
          factory(props: props, children: children, key: key);
