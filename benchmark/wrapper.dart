...
class Component implements react.Component, tiles.Component {
  ...
  Stream get needUpdate => _controller.stream;
...
initReact() {
  ...
  registerComponent = (tiles.ComponentFactory factory) {
    var registeredComponent = react.registerComponent((props, children) => factory(props: props, children: children));
    return ({props, children, key, Map listeners}) {
      if(props is Map) {
        props.addAll(listeners);
        props["key"] = key;
      }
      registeredComponent(props, children);
    };
  };
  var a = _ReactElementToTiles(react.a),
